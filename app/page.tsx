    ...
    <main className="mx-auto flex max-w-6xl flex-col gap-12 px-6 py-20">
      ...
      <section>
        ...
        <div className="grid gap-5 sm:grid-cols-3">
          ...
          <Link
            href="/kennisportaal"
            className="group flex flex-col gap-3 rounded-xl border border-zinc-200 bg-white p-6 transition hover:border-orange-300 hover:shadow-sm dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-orange-800"
          >
            ...
            <h3 className="font-semibold text-zinc-900 dark:text-zinc-50">Kennisportaal</h3>
          ...
          <div className="flex flex-col gap-3 rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <h3 className="font-semibold text-zinc-900 dark:text-zinc-50">Onderzoeksinstrumenten</h3>
            <p className="text-sm leading-relaxed text-zinc-500 dark:text-zinc-400">
          ...
          <div className="flex flex-col gap-3 rounded-xl border border-dashed border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <div className="flex items-center gap-2">
              <h3 className="font-semibold text-zinc-500 dark:text-zinc-400">Abonnementen</h3>
