...
export const ABBR_TITLES: Record<string, string> = {
  ...
  SNR:   'Single Number Rating — eén-getal beschermingswaarde gehoorbeschermer (EN 352/EN 458:2026)',
  OB:    'Octaafbandanalyse — meting van het geluidniveau per octaafband (63–8000 Hz), optioneel voor EN 458:2026 methode 3',
  APV:   'Assumed Protection Value (effectieve demping) — aangenomen beschermingswaarde conform EN 458:2026',
  APF:   'Assumed Protection Value (effectieve demping) — aangenomen beschermingswaarde conform EN 458:2026',
